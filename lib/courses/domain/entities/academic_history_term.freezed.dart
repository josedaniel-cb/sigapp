...
mixin _$AcademicHistoryCourse {
  ...
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $AcademicHistoryCourseCopyWith<AcademicHistoryCourse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AcademicHistoryCourseCopyWith<$Res> {
  factory $AcademicHistoryCourseCopyWith(AcademicHistoryCourse value,
          $Res Function(AcademicHistoryCourse) then) =
      _$AcademicHistoryCourseCopyWithImpl<$Res, AcademicHistoryCourse>;
  @useResult
  $Res call(
      {String courseCode,
      String courseName,
...
/// @nodoc
class _$AcademicHistoryCourseCopyWithImpl<$Res,
        $Val extends AcademicHistoryCourse>
    implements $AcademicHistoryCourseCopyWith<$Res> {
  _$AcademicHistoryCourseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$AcademicHistoryCourseImplCopyWith<$Res>
    implements $AcademicHistoryCourseCopyWith<$Res> {
  factory _$$AcademicHistoryCourseImplCopyWith(
          _$AcademicHistoryCourseImpl value,
          $Res Function(_$AcademicHistoryCourseImpl) then) =
      __$$AcademicHistoryCourseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String courseCode,
...
/// @nodoc
class __$$AcademicHistoryCourseImplCopyWithImpl<$Res>
    extends _$AcademicHistoryCourseCopyWithImpl<$Res,
        _$AcademicHistoryCourseImpl>
    implements _$$AcademicHistoryCourseImplCopyWith<$Res> {
  __$$AcademicHistoryCourseImplCopyWithImpl(_$AcademicHistoryCourseImpl _value,
      $Res Function(_$AcademicHistoryCourseImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$AcademicHistoryCourseImpl(
      courseCode: null == courseCode
          ? _value.courseCode
          : courseCode // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$AcademicHistoryCourseImpl
    with DiagnosticableTreeMixin
    implements _AcademicHistoryCourse {
  const _$AcademicHistoryCourseImpl(
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'AcademicHistoryCourse(courseCode: $courseCode, courseName: $courseName, courseType: $courseType, credits: $credits, grade: $grade)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'AcademicHistoryCourse'))
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$AcademicHistoryCourseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$AcademicHistoryCourseImplCopyWith<_$AcademicHistoryCourseImpl>
      get copyWith => __$$AcademicHistoryCourseImplCopyWithImpl<
          _$AcademicHistoryCourseImpl>(this, _$identity);
}

abstract class _AcademicHistoryCourse implements AcademicHistoryCourse {
  const factory _AcademicHistoryCourse(
