...
class App{
  ...
  static Future compartirCaptura(ScreenshotController screenshotController, String fileName, String descripcion) async {
    screenshotController
        .capture()
        .then((File image) async {
      await Share.file('Compartir', '$fileName.png', image.readAsBytesSync(), 'image/png', text: descripcion);
    }).catchError((onError) {
      print(onError);
    });
  }
  ...
  static Future compartirImagen(List<int> bytes, String fileName, String descripcion) async{
    Share.file('Compartir', '$fileName.png', bytes, 'image/png', text: descripcion);
  }
  ...
  static void compartirApp(){
    ...
    rootBundle.load('assets/images/compartir_imagen.png').then((data){
      App.compartirImagen(data.buffer.asUint8List(), 'a_whatsapp_p_aqui_No',
